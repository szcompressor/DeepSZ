...
for i in range(1, 10):
    ...
    net.save(line)
    line = caffe_home + "/build/tools/caffe test -model ./train_val.prototxt -weights ./decompressed_model/AlexNet-" + str(i) + "00.caffemodel -iterations 4 &> ./decompressed_model/caffe_test_log.txt"
    os.system(line)
